                ...
                <div className="flex flex-col gap-10">
                  <div>
                    <div className="flex flex-col">
                      ...
                      <div className="flex md:flex-col mt-[15px] gap-6">
                        <label className="text-gray-700 text-sm flex-1">
                          Email
                          <input
                            className="w-full pl-3.5 pr-[35px] py-[5px] sm:pr-5 text-gray-900_01 text-left text-base border border-gray-600 border-solid bg-white-A700 rounded"
                            {...register("email", {
                              required: "This field is required",
                            })}
                          ></input>
